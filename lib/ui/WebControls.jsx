    ...
    <div className={ControlStyles["time"]}>
      {!player.isLive ? null : (
        <button
          ...
          className={ControlStyles["live-indicator"]}
        >
          Live
        </button>
      )}
...
const ContentInfo = ({ player, contentInfo }) => {
  ...
  function fetchData() {
    async function _fetchData() {
      const { title, subtitle, rating } = player.playerOptions.previewMode
        ? contentInfo || {}
  ...
  return (
    <div
      ...
      className={[
        ...
        showUI ||
        player.playerOptions.previewMode ||
        !player.controls.IsPlaying()
          ? ""
          : ControlStyles["autohide"],
