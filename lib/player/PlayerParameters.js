...
export const DefaultParameters = {
  ...
  playerOptions: {
    ...
    previewMode: false,
    // Share popup configuration. When provided, the share button in the
    // bottom-right control cluster is enabled. Shape:
    //   { baseUrl, embedSrc?, title?, templates? }
    // - baseUrl: canonical URL to share (defaults to window.location.href)
    // - embedSrc: iframe src for the Embed channel; omit to hide Embed
    // - title:   text used in pre-populated social messages
    // - templates: per-channel URL builder overrides (see share/channels.js)
